        ...
        <div className="max-w-6xl mx-auto">
          ...
          {!isSearching && (
            <>
              ...
              {groups.map((group) => (
                <motion.div key={group.id} id={`section-${group.id}`} initial="hidden" animate="visible" variants={stagger} className="mb-16">
              ...
              {/* Ungrouped series — Parsha, Yamim Tovim, full archive — in one filled grid (no orphan cards) */}
              {ungrouped.length > 0 && (
                <motion.div initial="hidden" animate="visible" variants={stagger} className="mb-16">
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      <h2 className="serif-heading text-brown text-4xl font-bold">More to Learn</h2>
                      <p className="text-brown/60 text-sm mt-1">Parsha, Yamim Tovim, and the full shiur archive</p>
                    </div>
                  </motion.div>
                  <motion.div variants={fadeUp} className="w-20 h-1 bg-amber mb-10" />
